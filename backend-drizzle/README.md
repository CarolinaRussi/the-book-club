...
| `pnpm reviews:remind` | Envia o digest de lembrete de nota a quem ainda não avaliou livros `finished` do clube; útil sem esperar o cron. `pnpm reviews:remind -- --feedback` manda o lote só para `FEEDBACK_TO_EMAIL` |
